										...
										<tr>
											...
											<td width="35%">
												<#if column.comment?index_of("字典") gt 0 >
													<select prompt="<s:text name='label.select.default.value' />" disabled
												...
												<#elseif column.typeName == "Date">
													<input type="text" id="${column.name}" class="date input_w180" disabled
												...
												<#elseif column.typeName == "BigDecimal">
													<#if column.size == 26>
														<input type="text" id="${column.name}" name="${className?uncap_first}.${column.name}" disabled
												...
												<#else>
													<input type="text" id="${column.name}" name="${className?uncap_first}.${column.name}" disabled value="<s:property value='${className?uncap_first}.${column.name}' />"  class="input_w180"/>
												</#if>
											</td>
										</tr>
									</#if>
