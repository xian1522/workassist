  	...
  	<form id="edit_form" target="frmright">
		<div id="formContent" whiteBg="true" class="showbox">
			<div class="btn_area" id="button">
				...
				<div id="toolbarBtn1" class="l-toolbar-item l-panel-btn l-toolbar-item-hasicon" >
					<div class="l-panel-btn-l"></div>
					<div class="l-panel-btn-r"></div>
					<div class="l-icon icon_ok left" onmouseover="setBtnOver(toolbarBtn1)" onmouseout="setBtnOut(toolbarBtn1)" onclick="submit${className}();return false;">
					<s:text name="button.submit"/></div>
				</div>	
