...
<script src="${r"${pageContext.request.contextPath}"}/javascript/sysmn${packageName?replace(".","/")}/${className?uncap_first}Edit.js" type="text/javascript"></script>
...
<input type="hidden" id="${pkname?lower_case}" name="${className?uncap_first}.${pkname?lower_case}" value="<s:property value="${className?uncap_first}.${pkname?lower_case}"/>" />
<input type="hidden" id="taskId" name="${className?uncap_first}.createuser" value="<s:property value="${className?uncap_first}.createuser"/>" />
